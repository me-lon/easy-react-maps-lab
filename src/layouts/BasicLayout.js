...
class BasicLayout extends React.PureComponent {
    ...
    getPageTitle() {
        ...
        if (currRouterData && currRouterData.name) {
            title = `${currRouterData.name} - ${myConfig.title}`;
        }
        return title;
    }
    getBashRedirect = () => {
    ...
    handleMenuClick = ({ key }) => {
        if (key === 'people') {
            this.props.dispatch(routerRedux.push(`/people/${this.props.currentuser.userid}`));
            return;
        }
        if (key === 'setting') {
                    ...
                    <GlobalFooter
                        links={[
                            ...
                            },
                            {
                                ...
                                href: 'https://github.com/piscium-proj/piscium',
                                blankTarget: true,
                            },
                        ]}
                        copyright={
